    ...
    ui(new Ui::FormPart)
{
    ...
    ui->tableViewSrcMech->setColumnWidth(1,50);
    ui->tableViewSrcMech->setColumnWidth(2,50);
    ui->tableViewSrcMech->setColumnWidth(3,180);
    ui->tableViewSrcMech->setColumnWidth(4,80);
